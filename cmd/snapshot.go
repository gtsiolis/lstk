...
This reads the on-disk .snapshot file directly — no running emulator, no platform call, and no authentication. It is the local counterpart to 'snapshot show', which reports metadata for cloud snapshots. Sizes are grouped by control-plane service and data-asset category, largest first.
